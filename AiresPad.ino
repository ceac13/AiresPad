...
int threshold[13] =      {10, padS, padS, padS, padS, padS, padS, padS, 50, padS, 60, 20, 20}; // Minimum value to get trigger
float gain[13] =      {1.0, padG, padG, padG, padG, padG, padG, padG, 2.7, padG, 2.0, 2.0, 2.0}; // multiplier to apply in the analog pin values
...
double crosstalkRatio = 2.2; // Less than crosstalkRatio * threshold will be removed 
